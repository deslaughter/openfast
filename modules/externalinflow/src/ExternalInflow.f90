...
CONTAINS
!----------------------------------------------------------------------------------------------------------------------------------
SUBROUTINE Init_ExtInfw( InitInp, p_FAST, AirDens, u_AD, initOut_AD, y_AD, y_ED, y_BD, ExtInfw, InitOut, ErrStat, ErrMsg )
!..................................................................................................................................
...
!         ExtInfw%m%ActForceLoads(k)%RemapFlag = .false.
   ...
   call SetExtInfwPositions(p_FAST, u_AD, y_ED, y_BD, ExtInfw, ErrStat2, ErrMsg2)
   call SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
...
!----------------------------------------------------------------------------------------------------------------------------------
SUBROUTINE ExtInfw_SetInputs( p_FAST, u_AD, y_AD, y_ED, y_BD, y_SrvD, ExtInfw, ErrStat, ErrMsg )
!..................................................................................................................................
   ...
   call SetExtInfwPositions(p_FAST, u_AD, y_ED, y_BD, ExtInfw, ErrStat2, ErrMsg2)
      ...
      ! set the forces
   call SetExtInfwForces(p_FAST, u_AD, y_AD, y_ED, y_BD, ExtInfw, ErrStat2, ErrMsg2)
      call SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )


END SUBROUTINE ExtInfw_SetInputs
!----------------------------------------------------------------------------------------------------------------------------------
SUBROUTINE SetExtInfwPositions(p_FAST, u_AD, y_ED, y_BD, ExtInfw, ErrStat, ErrMsg)
...
!----------------------------------------------------------------------------------------------------------------------------------
SUBROUTINE SetExtInfwForces(p_FAST, u_AD, y_AD, y_ED, y_BD, ExtInfw, ErrStat, ErrMsg)

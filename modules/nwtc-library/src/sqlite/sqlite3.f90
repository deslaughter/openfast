...
contains
    function sqlite3_backup_init(p_dest, z_dest_name, p_source, z_source_name)
        ...
        character(*),     intent(in) :: z_dest_name
        type(c_ptr),      intent(in) :: p_source
        character(*),     intent(in) :: z_source_name
    ...
    function sqlite3_column_text(stmt, icol)
        ...
        type(c_ptr)                   :: ptr
        character(:), allocatable     :: sqlite3_column_text
    ...
    function sqlite3_db_name(db, n)
        ...
        integer,     intent(in)       :: n
        character(:), allocatable     :: sqlite3_db_name
        type(c_ptr)                   :: ptr
    ...
    function sqlite3_errmsg(db)
        type(c_ptr), intent(in)       :: db
        character(:), allocatable     :: sqlite3_errmsg
        type(c_ptr)                   :: ptr
    ...
    function sqlite3_libversion()
        type(c_ptr)                   :: ptr
        character(:), allocatable     :: sqlite3_libversion
    ...
    function sqlite3_sourceid()
        type(c_ptr)                   :: ptr
        character(:), allocatable     :: sqlite3_sourceid
    ...
    function sqlite3_str_value(str)
        type(c_ptr)                   :: str
        type(c_ptr)                   :: ptr
        character(:), allocatable     :: sqlite3_str_value
